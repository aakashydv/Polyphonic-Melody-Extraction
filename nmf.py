...
plt.subplot(4,2,1)                                       # INPUT AUDIO SIGNAL POWER SPECTROGRAM
...
import matplotlib.pyplot as plt
import librosa.display
plt.figure(figsize=(20, 20))                             # RECONSTRUCTED POWER SPECTROGRAM
plt.subplot(4,2,1)
...
import librosa.display
plt.figure(figsize=(20, 20))
plt.subplot(4,2,1)                                       # BASIS VECTOR SPECTROGRAM
